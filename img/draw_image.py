...
def draw_some_line_chart(x_ticks, y_data, n_row, n_col, title, sub_title, x_label, y_label, save_name=None,
    ...
    画多个对比折现图
    """
    figure, axes = plt.subplots(n_row, n_col, figsize=(26,10), constrained_layout=True)
    ...
    for j in range(n_col):
        ...
        axes[1][j].set_xlabel("Base classifier number")
...
[
[[33.332049703463596, 33.330766073593864, 33.3281988138544, 33.32306429437546, 33.31279525541759, 33.29225717750185, 33.251181021670384, 33.16902871000743, 33.00472408668153, 32.67611484002973, 32.01889634672613, 30.704459360118925, 28.07558538690452, 22.817837440475707, 12.302341547618086],
[33.338153219088596, 33.342973104843864, 33.3526128763544, 33.37189241937546, 33.41045150541759, 33.48756967750185, 33.641806021670384, 33.95027871000743, 34.56722408668153, 35.80111484002973, 38.26889634672613, 43.204459360118925, 53.07558538690452, 72.81783744047571, 112.30234154761808]],
